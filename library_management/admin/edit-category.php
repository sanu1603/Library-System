...
$id = $_GET['id'];
$fetch_query = mysqli_query($conn, "select * from category where id='$id'");
...
if(isset($_REQUEST['sv-cat']))
{
  ...
  $update_category = mysqli_query($conn,"update category set category_name='$category_name', status='$status' where id='$id'");
