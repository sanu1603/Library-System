...
$id = $_GET['id'];
$fetch_query = mysqli_query($conn, "select * from users where id='$id'");
...
if(isset($_REQUEST['sv-user']))
{
  ...
  $update_user = mysqli_query($conn,"update users set user_name='$user_name', emailid='$emailid', role='$role', status='$status' where id='$id'");
