          ...
          <div class="card-header">
            ...
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
										<?php 
										$select_query = mysqli_query($conn, "select issue.status, issue.book_id, book.book_name, issue.id, issue.user_name, book.quantity from issue inner join book on book.id=issue.book_id");
										$sn = 1;
