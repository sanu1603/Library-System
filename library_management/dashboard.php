...
$select_book = mysqli_query($conn,"select count(*) from book where availability=1");
 $total_book = mysqli_fetch_row($select_book);

$issued_book = mysqli_query($conn,"select count(*) from issue where user_id='$id'  and status=1");
