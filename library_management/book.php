            ...
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                <thead>
                    ...
                    if(isset($_GET['ids'])){
                      $id = $_GET['ids'];
                      $delete_query = mysqli_query($conn, "delete from book where id='$id'");
                      }
										$select_query = mysqli_query($conn, "select * from book where availability=1");
										$sn = 1;
                                        ...
                                        <?php } else { ?><td><span class="badge badge-danger">Not Available</span></td>
                                          ...
                                          $fetch_issue_details = mysqli_query($conn, "select status from issue where user_id='$ids' and book_id='$id'");
